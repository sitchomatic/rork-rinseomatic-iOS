...
class LiveSpeedAdaptationService {
    ...
    func adaptedDelays(from settings: AutomationSettings) -> AdaptedDelays {
        ...
        return AdaptedDelays(
            pageStabilizationMs: clampDelay(Int(Double(settings.pageStabilizationDelayMs) * m), min: settings.pageStabilizationDelayMs, max: 5000),
            ajaxSettleMs: clampDelay(Int(Double(settings.ajaxSettleDelayMs) * m), min: settings.ajaxSettleDelayMs, max: 5000),
            domMutationMs: clampDelay(Int(Double(settings.domMutationSettleMs) * m), min: settings.domMutationSettleMs, max: 3000),
            animationSettleMs: clampDelay(Int(Double(settings.animationSettleDelayMs) * m), min: settings.animationSettleDelayMs, max: 3000),
            betweenAttemptsMs: clampDelay(Int(Double(settings.betweenAttemptsDelayMs) * m), min: settings.betweenAttemptsDelayMs, max: 5000),
            betweenCredentialsMs: clampDelay(Int(Double(settings.betweenCredentialsDelayMs) * m), min: settings.betweenCredentialsDelayMs, max: 3000),
            preNavigationMs: clampDelay(Int(Double(settings.preNavigationDelayMs) * m), min: settings.preNavigationDelayMs, max: 2000),
            postNavigationMs: clampDelay(Int(Double(settings.postNavigationDelayMs) * m), min: settings.postNavigationDelayMs, max: 3000),
            preTypingMs: clampDelay(Int(Double(settings.preTypingDelayMs) * m), min: settings.preTypingDelayMs, max: 1500),
            postTypingMs: clampDelay(Int(Double(settings.postTypingDelayMs) * m), min: settings.postTypingDelayMs, max: 1500),
            preSubmitMs: clampDelay(Int(Double(settings.preSubmitDelayMs) * m), min: settings.preSubmitDelayMs, max: 2000),
            postSubmitMs: clampDelay(Int(Double(settings.postSubmitDelayMs) * m), min: settings.postSubmitDelayMs, max: 3000),
            cooldownBetweenBatchesMs: clampDelay(Int(Double(settings.sessionCooldownDelayMs) * m), min: settings.sessionCooldownDelayMs, max: 5000)
        )
    }
