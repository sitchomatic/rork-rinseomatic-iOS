...
public enum HyperFlowTaskFactory {
    ...
    public static func loginDualSitePair(
        ...
        PairedTask(
            ...
            primaryURL: joeURL ?? URL(string: "https://joefortunepokies.eu/login")!,
...
nonisolated enum LoginTargetSite: String, CaseIterable, Sendable {
    ...
    var url: URL {
        switch self {
        case .joefortune: URL(string: "https://joefortunepokies.eu/login")!
    ...
    var host: String {
        switch self {
        case .joefortune: "joefortunepokies.eu"
